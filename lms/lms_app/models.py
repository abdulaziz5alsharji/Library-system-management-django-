...
class Book(models.Model):
    ...
    author = models.CharField(max_length=250, null=True, blank=True, verbose_name="Author")
    ...
    status = models.CharField("Status", max_length=50, choices=status_book, null=True, blank=True)
